...
In this example, the Project is created here, so its targets and
generated files get their own build directory, but the toolchain, the
flags and the located Qt install all come from the parent. Sources are
read from this script's directory.
"""
