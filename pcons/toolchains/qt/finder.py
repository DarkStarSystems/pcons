...
def _own_install(project: Project, key: _InstallKey) -> QtPackage | None:
    """The install *project* itself located under *key*, ignoring its parents.
    ...
    """
    return _qt_installs.get(project, {}).get(key)
